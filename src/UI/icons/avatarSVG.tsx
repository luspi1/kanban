...
export const AvatarSvg: FC<AvatarSVGProps> = ({ color }) => {
	return (
		<svg
			...
			<g>
				<defs>
					<clipPath id='a' clipPathUnits='userSpaceOnUse'>
						<path d='M0 512h512V0H0Z' fill={color} data-original={color}></path>
					</clipPath>
				</defs>
				<g transform='matrix(1.33333 0 0 -1.33333 0 682.667)'>
					...
					<path
						...
						transform='translate(106.65 60.03)'
						fill='none'
						stroke={color}
						strokeWidth='20'
						strokeLinecap='round'
					...
					<path
						...
						transform='translate(466.42 383.592)'
						fill='none'
						stroke={color}
						strokeWidth='20'
						strokeLinecap='round'
